...
export interface ApiEventEvent extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String &
      ...
      Attribute.DefaultTo<'Enter event Title'>;
    user: Attribute.Relation<'api::event.event', 'oneToOne', 'admin::user'>;
    ...
    featured_photo: Attribute.Media &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiTicketTicket extends Schema.CollectionType {
  ...
  attributes: {
    ...
    status: Attribute.Enumeration<['new', 'used', 'invalid']> &
      Attribute.Required &
